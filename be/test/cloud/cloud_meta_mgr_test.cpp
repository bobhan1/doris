...
TEST_F(CloudMetaMgrTest, test_get_delete_bitmap_from_ms_by_batch) {
    ...
    // Test case 5: V2 delete bitmap handling with multiple batches
    {
        ...
        sp->set_call_back("CloudMetaMgr::_get_delete_bitmap_from_ms", [&call_count](auto&& args) {
            ...
            if (call_count == 1) {
                // First batch: v2 delete bitmap data
                res->add_delta_rowset_ids("delta_rowset_1");
                res->add_delete_bitmap_storages("storage_path_1");
                res->add_returned_rowset_ids("rowset_1");
                res->set_has_more(true);
            } else if (call_count == 2) {
                // Second batch: more v2 delete bitmap data
                res->add_delta_rowset_ids("delta_rowset_2");
                res->add_delete_bitmap_storages("storage_path_2");
                res->add_returned_rowset_ids("rowset_2");
        ...
        EXPECT_EQ(res.delete_bitmap_storages(0), "storage_path_1");
        EXPECT_EQ(res.delete_bitmap_storages(1), "storage_path_2");
    ...
    // Test case 6: Mixed V1 and V2 delete bitmap handling
    {
        ...
        sp->set_call_back("CloudMetaMgr::_get_delete_bitmap_from_ms", [&call_count](auto&& args) {
            ...
            if (call_count == 1) {
                ...
                // V2 delete bitmap data
                res->add_delta_rowset_ids("delta_rowset_1");
                res->add_delete_bitmap_storages("v2_storage_path_1");
                ...
                // More V2 data
                res->add_delta_rowset_ids("delta_rowset_2");
                res->add_delete_bitmap_storages("v2_storage_path_2");
                res->add_delta_rowset_ids("delta_rowset_3");
                res->add_delete_bitmap_storages("v2_storage_path_3");
        ...
        EXPECT_EQ(res.delete_bitmap_storages(0), "v2_storage_path_1");
        EXPECT_EQ(res.delete_bitmap_storages(1), "v2_storage_path_2");
        EXPECT_EQ(res.delete_bitmap_storages(2), "v2_storage_path_3");
