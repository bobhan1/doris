...
Status CloudCumulativeCompaction::modify_rowsets() {
    ...
    LOG(INFO) << "tablet stats=" << stats.ShortDebugString();
    {
        ...
        LOG_INFO("CloudCumu get header_lock, begin update tablet stats, tablet_id={}, job_id={}",
        ...
        LOG_INFO(
                "CloudCumu release header_lock, finish update tablet stats, tablet_id={}, "
                "job_id={}",
                _tablet->tablet_id(), _uuid);
    }
    return Status::OK();
