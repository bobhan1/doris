...
// should be false
DEFINE_mBool(enable_segments_key_bounds_truncation, "true");
// slightly lower than the limit of FoundationDB value size limit(100000B)
DEFINE_mInt64(fdb_value_size_limit, "99500");
